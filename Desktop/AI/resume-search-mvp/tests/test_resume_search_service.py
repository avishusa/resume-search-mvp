...
def test_candidate_with_four_years_is_excluded_for_min_five_years() -> None:
    repository = InMemoryResumeRepository()
...
def test_candidate_with_null_experience_is_excluded_when_min_experience_required() -> None:
    repository = InMemoryResumeRepository()
